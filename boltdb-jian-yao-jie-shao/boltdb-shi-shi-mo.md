...
> Bolt is a pure Go key/value store inspired by \[Howard Chu's\]\[hyc\_symas\] \[LMDB project\]\[lmdb\]. The goal of the project is to provide a simple, fast, and reliable database for projects that don't require a full database server such as Postgres or MySQL.
>
